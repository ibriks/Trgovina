...
namespace Projekt {
    ...
    public partial class shopDataSet : global::System.Data.DataSet {
        ...
        public partial class ArtiklDataTable : global::System.Data.TypedTableBase<ArtiklRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ArtiklRow AddArtiklRow(string Naziv, string Kod, double Cijena, System.DateTime Rok_Trajanja, double Količina) {
...
namespace Projekt.shopDataSetTableAdapters {
    ...
    public partial class ArtiklTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Artikl] WHERE (([Artikl_Id] = @Original_Artikl_Id) AND ((@IsNull_Naziv = 1 AND [Naziv] IS NULL) OR ([Naziv] = @Original_Naziv)) AND ((@IsNull_Kod = 1 AND [Kod] IS NULL) OR ([Kod] = @Original_Kod)) AND ((@IsNull_Cijena = 1 AND [Cijena] IS NULL) OR ([Cijena] = @Original_Cijena)) AND ((@IsNull_Rok_Trajanja = 1 AND [Rok_Trajanja] IS NULL) OR ([Rok_Trajanja] = @Original_Rok_Trajanja)) AND ((@IsNull_Količina = 1 AND [Količina] IS NULL) OR ([Količina] = @Original_Količina)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Artikl] ([Naziv], [Kod], [Cijena], [Rok_Trajanja], [Količina])" +
                " VALUES (@Naziv, @Kod, @Cijena, @Rok_Trajanja, @Količina);\r\nSELECT Artikl_Id, Na" +
                "ziv, Kod, Cijena, Rok_Trajanja, Količina FROM Artikl WHERE (Artikl_Id = SCOPE_ID" +
                "ENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Artikl] SET [Naziv] = @Naziv, [Kod] = @Kod, [Cijena] = @Cijena, [Rok_Trajanja] = @Rok_Trajanja, [Količina] = @Količina WHERE (([Artikl_Id] = @Original_Artikl_Id) AND ((@IsNull_Naziv = 1 AND [Naziv] IS NULL) OR ([Naziv] = @Original_Naziv)) AND ((@IsNull_Kod = 1 AND [Kod] IS NULL) OR ([Kod] = @Original_Kod)) AND ((@IsNull_Cijena = 1 AND [Cijena] IS NULL) OR ([Cijena] = @Original_Cijena)) AND ((@IsNull_Rok_Trajanja = 1 AND [Rok_Trajanja] IS NULL) OR ([Rok_Trajanja] = @Original_Rok_Trajanja)) AND ((@IsNull_Količina = 1 AND [Količina] IS NULL) OR ([Količina] = @Original_Količina)));
SELECT Artikl_Id, Naziv, Kod, Cijena, Rok_Trajanja, Količina FROM Artikl WHERE (Artikl_Id = @Artikl_Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Artikl_Id, Naziv, Kod, Cijena, Rok_Trajanja, Količina FROM dbo.Artikl";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT Artikl_Id, Naziv, Kod, Cijena, Rok_Trajanja, Količina FROM dbo.Artikl WHER" +
                "E Naziv LIKE @Naziv OR Naziv LIKE @Naziv1";
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Naziv1", global::System.Data.SqlDbType.NVarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "Naziv", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT Artikl_Id, Naziv, Kod, Cijena, Rok_Trajanja, Količina FROM dbo.Artikl WHER" +
                "E Kod LIKE @Kod";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Kod", global::System.Data.SqlDbType.NVarChar, 20, global::System.Data.ParameterDirection.Input, 0, 0, "Kod", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "SELECT Artikl_Id, Naziv, Kod, Cijena, Rok_Trajanja, Količina FROM dbo.Artikl WHER" +
                "E Rok_Trajanja < @Rok_Trajanja";
            this._commandCollection[3].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Rok_Trajanja", global::System.Data.SqlDbType.DateTime, 8, global::System.Data.ParameterDirection.Input, 0, 0, "Rok_Trajanja", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[4] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[4].Connection = this.Connection;
            this._commandCollection[4].CommandText = "SELECT Artikl_Id, Naziv, Kod, Cijena, Rok_Trajanja, Količina FROM dbo.Artikl WHER" +
                "E Količina < 20 AND Količina > 0";
        ...
        public virtual int Fill(shopDataSet.ArtiklDataTable dataTable) {
        ...
        public virtual shopDataSet.ArtiklDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            shopDataSet.ArtiklDataTable dataTable = new shopDataSet.ArtiklDataTable();
        ...
        public virtual int FillBy(shopDataSet.ArtiklDataTable dataTable, string Naziv, string Naziv1) {
            ...
            if ((Naziv1 == null)) {
                ...
                this.Adapter.SelectCommand.Parameters[1].Value = ((string)(Naziv1));
            }
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillBy1(shopDataSet.ArtiklDataTable dataTable, string Kod) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillBy2(shopDataSet.ArtiklDataTable dataTable, global::System.Nullable<global::System.DateTime> Rok_Trajanja) {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            if ((Rok_Trajanja.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((System.DateTime)(Rok_Trajanja.Value));
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillBy3(shopDataSet.ArtiklDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(shopDataSet.ArtiklDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Artikl_Id, string Original_Naziv, string Original_Kod, global::System.Nullable<double> Original_Cijena, global::System.Nullable<global::System.DateTime> Original_Rok_Trajanja, global::System.Nullable<double> Original_Količina) {
            ...
            if ((Original_Rok_Trajanja.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[8].Value = ((System.DateTime)(Original_Rok_Trajanja.Value));
            }
            else {
            ...
            if ((Original_Količina.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[10].Value = ((double)(Original_Količina.Value));
            }
            else {
        ...
        public virtual int Insert(string Naziv, string Kod, global::System.Nullable<double> Cijena, global::System.Nullable<global::System.DateTime> Rok_Trajanja, global::System.Nullable<double> Količina) {
            if ((Naziv == null)) {
        ...
        public virtual int Update(string Naziv, string Kod, global::System.Nullable<double> Cijena, global::System.Nullable<global::System.DateTime> Rok_Trajanja, global::System.Nullable<double> Količina, int Original_Artikl_Id, string Original_Naziv, string Original_Kod, global::System.Nullable<double> Original_Cijena, global::System.Nullable<global::System.DateTime> Original_Rok_Trajanja, global::System.Nullable<double> Original_Količina, int Artikl_Id) {
            if ((Naziv == null)) {
            ...
            if ((Količina.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[4].Value = ((double)(Količina.Value));
            }
            else {
            ...
            if ((Original_Rok_Trajanja.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[13].Value = ((System.DateTime)(Original_Rok_Trajanja.Value));
            }
            else {
            ...
            if ((Original_Količina.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[15].Value = ((double)(Original_Količina.Value));
            }
            else {
                this.Adapter.UpdateCommand.Parameters[14].Value = ((object)(1));
                this.Adapter.UpdateCommand.Parameters[15].Value = global::System.DBNull.Value;
            }
            this.Adapter.UpdateCommand.Parameters[16].Value = ((int)(Artikl_Id));
        ...
        public virtual int Update(string Naziv, string Kod, global::System.Nullable<double> Cijena, global::System.Nullable<global::System.DateTime> Rok_Trajanja, global::System.Nullable<double> Količina, int Original_Artikl_Id, string Original_Naziv, string Original_Kod, global::System.Nullable<double> Original_Cijena, global::System.Nullable<global::System.DateTime> Original_Rok_Trajanja, global::System.Nullable<double> Original_Količina) {
            return this.Update(Naziv, Kod, Cijena, Rok_Trajanja, Količina, Original_Artikl_Id, Original_Naziv, Original_Kod, Original_Cijena, Original_Rok_Trajanja, Original_Količina, Original_Artikl_Id);
        }
    }
